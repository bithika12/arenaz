...
export class MailComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  columns: TableColumn<Player>[] = [
    ...
    { label: 'Read Status', property: 'read_unread', type: 'text', visible: true },
    
    { label: 'Received UserId', property: 'received_by_user', type: 'text', visible: true },
    { label: 'Message', property: 'message', type: 'text', visible: true },
    { label: 'Created Time', property: 'created_at', type: 'text', visible: true },
  ...
  constructor(private dialog: MatDialog, private coinService:CoinService, private mailService:MailService,private userService:UserService,private location: Location) {
  }
  ...
  ngOnInit() {
    ...
    this.mailService.getAllNotification().subscribe(users => {
  ...
  deletePlayer(player: Player) {
   ...
   this.mailService.deleteMail(player).subscribe(user => {
