...
import { DartService } from '../../../app/pages/services/dart.service';
...
export class DartComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  columns: TableColumn<Player>[] = [
    ...
    { label: 'Game Name', property: 'matchName', type: 'text', visible: true },
    ...
    { label: 'First User Game Status', property: 'firstUserWinStatus', type: 'text', visible: true, cssClasses: ['font-medium'] },
    { label: 'Second Username', property: 'second_user', type: 'text', visible: true },
    { label: 'Second User Game Status', property: 'secondUserWinStatus', type: 'text', visible: true, cssClasses: ['font-medium'] },
    { label: 'First User Score', property: 'first_user_score', type: 'text', visible: true, cssClasses: ['font-medium'] },
    { label: 'Second User Score', property: 'second_user_score', type: 'text', visible: true },
    { label: 'Winner Username', property: 'winner_user', type: 'text', visible: true },
  ...
  constructor(private dialog: MatDialog, private dartService:DartService,private userService:UserService,private location: Location) {
  }
  ...
  ngOnInit() {
    ...
    this.dartService.getAllGames().subscribe(users => {
  ...
  deletePlayer(player: Player) {
   ...
   this.dartService.deleteUser(player).subscribe(user => {
