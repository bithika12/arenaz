...
export class AppversionComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  columns: TableColumn<Player>[] = [
    ...
    { label: 'Master Message  ', property: 'master_message', type: 'text', visible: true },
  ...
  ngOnInit() {
    ...
    this.coinService.getVersions().subscribe(users => {
