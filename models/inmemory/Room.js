         ...
         , function (err, result) {
                 if (result) {
                     ...
                     if (calculatedScore == 0) {
                         ...
                         userArr.findIndex(function (elemt) {
                             if (elemt.userId == reqObj.userId)
                                 newArr.push({score:score,total:calculatedScore,userId:elemt.userId,status:elemt.status,isWin:1,turn:userTurn});
                             else
                                 newArr1.push({score:elemt.score,total:elemt.total,userId:elemt.userId,status:elemt.status,isWin:1,turn:elemt.turn});
                      ...
                      */
                         ...
                         userArr.findIndex(function (elemt) {
                             if (elemt.userId == reqObj.userId)
                                 newArr.push({score:score,total:calculatedScore,userId:elemt.userId,status:elemt.status,turn:userTurn});
                             else
                                 newArr1.push({score:elemt.score,total:elemt.total,userId:elemt.userId,status:elemt.status,turn:elemt.turn});
                         ...
                         let finalArr=result;
                         resolve({users: reqObj.userId,remainingScore:calculatedScore,finalArr:finalArr,userTurn:userTurn});
      ...
      if(roomresult == null || roomresult.length ==  0){         
            ...
            room.insert({
                ...
                if(err)
                  ...
                  resolve({users: insertroomresult.users,direction : userDirection, roomName : insertroomresult._id ,noOfRound : 1})
            })
      }else{
             ...
             let totalArr=[];
              userArr.findIndex(function (elemt) {
                  if (elemt.userId == condObj.userId)
                      newArr.push({score:elemt.score,total:elemt.total,userId:elemt.userId,status:"inactive",isWin:elemt.isWin,turn:elemt.turn,dartPoint:elemt.dartPoint});
                  else
                      newArr1.push({score:elemt.score,total:elemt.total,userId:elemt.userId,status:"active",isWin:elemt.isWin,turn:elemt.turn,dartPoint:elemt.dartPoint});
