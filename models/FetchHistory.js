...
const chkTransactionStatus =(condObj) =>{
    return  new Promise((resolve,reject) => {
        Transaction.findOne(condObj,{_id: 1,status:1,user_name:1,user_email:1,expired_at:1,amount:1,created_at:1,user_confirmation:1,transaction_id:1}).then(transactiondetails=> {
